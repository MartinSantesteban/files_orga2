...
modo_protegido:
    ...
    ; Inicializar tss
    call tss_init                   ;; mete en la gdt al descriptor de TSS de la tarea inicial y de la idle
    
    ; Inicializar el scheduler
    call sched_init                 ;; Se inicializa el scheduler, poniendo a todas las entradas en -1. Los -1 representan slots libres <- cada entrada es id;selector;estado

    ; Inicializar las tareas
    call task_init                  ;; Inicializa todas las tareas del usuario en todas las estructuras
    ...
    mov ax, TASK_INITIAL_SEL ;; lo muevo asi nomas, con table indicator en 0 y dpl en 0 
