    ...
    [GDT_IDX_CODE_0] =
        {
            ...
            .limit_15_0 = 0x30FF, //tiene que direccionar los primeros 817Mib = 817 * 2²⁰B   <- lo saco calculando |817 * 2²⁰| - 1 convertido a 4KB.
            .base_15_0 = 0x0000,
            .base_23_16 = 0x00,
            .type = 0xA,       // ejectuar / lectura = 1 0 1 0 ( 11 10 9 8 )
            .s = 0x01,         // si esta clear es de sistema, sino es de datos/codigo 
            .dpl = 0x00,       // dpl en 0 
            .p = 0x01,         // esta presente en RAM
            .limit_19_16 = 0x03,  //continuacion del limite
            .avl = 0x0,         
            .l = 0x0, 
            .db = 0x1,         //queremos codigo de 32 bits
            .g = 0x01,         //esto me cambia directamente el valor del limite. Cada offset esta en 4K
            .base_31_24 = 0x00, //La base es cero, ya que cubre los primeros 817 Mib
    ...
    [GDT_IDX_DATA_0] =
        {
            ...
            .base_23_16 = 0x00,
            .type = 0x2,
            .s = 0x01,    //si esto esta en cero genera GP
            .dpl = 0x00,
            .p = 0x01,
            .limit_19_16 = 0x03,
            .avl = 0x0,
    ...
    [GDT_IDX_VIDEO] =
        {
            ...
            // Pueden tomar el descriptor nulo como ejemplo y completar cada uno de los campos
            // con lo correspondiente acorde a lo solicitado en el enunciado
            .limit_15_0 = 0x1F3F, // limite = tamaño -1 = maximo offset, NO REPRESENTA UNA POSICION DE MEMORIA, SINO UN OFFSET 
            .base_15_0 = 0x8000,
            .base_23_16 = 0x0B,
            .type = 0x2, // datos, r/w
            .s = 0x01,
