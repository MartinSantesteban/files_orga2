...
COMPLEX_ITEM_LENGTH	EQU	32 ;?? completar valor      <- son 32 Bytes  <- En C esta definido el struct, que contiene 4 atributos: 2 de 64 y 2 de 32 bits. Como esta alineado el tamaño es 4 veces 64
COMPLEX_ITEM_Z_OFFSET	EQU	24 ;?? completar valor <- Asi solo sumamos el 4to atributo
...
;registros: arr[rdi], arr_length[rsi]                                     ;; SUMA CIERTO ATRIBUTO DE UN ARREGLO DE ESTRUCTURAS!
complex_sum_z:
	;prologo
...
;	, x9[rbp + 0x28], f9[rbp + 0x30] ;; por mas que sean de 32 hago bloques de 64 en el stack. voy sumando de a 8 pq tengo direccionamiento a byte.
product_9_f:
	push rbp
	mov rbp, rsp
